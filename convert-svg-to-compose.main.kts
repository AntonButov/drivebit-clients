...
@file:DependsOn("com.github.DevSrSouza:svg-to-compose:0.11.0")
...
val assetsDir = File("svg-assets")
val srcDir = File("composeApp/src/commonMain/kotlin/my/drivebit/clients/ui/icons")

Svg2Compose.parse(
    applicationIconPackage = "my.drivebit.clients.ui.icons",
    accessorName = "TripIconGenerated",
    outputSourceDirectory = srcDir,
    vectorsDirectory = assetsDir,
    type = VectorType.SVG,
    allAssetsPropertyName = "AllTripIcons",
)

...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const wasmFilePath = './Drivebitclients-composeApp.wasm';
    const importObject = {
        js_code,
        intrinsics: {
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./Drivebitclients-composeApp.wasm',import.meta.url).href), importObject)).instance;
      }
    } catch (e) {

...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const wasmFilePath = './Drivebitclients-composeApp-test.wasm';
    const importObject = {
        js_code,
        intrinsics: {
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./Drivebitclients-composeApp-test.wasm',import.meta.url).href), importObject)).instance;
      }
    } catch (e) {
